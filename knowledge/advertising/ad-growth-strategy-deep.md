...
1. **设定显著性水平 α**：通常取 0.05，对应 95% 置信度
2. **设定检验功效 1-β**：通常取 0.8，即 80% 概率能检测到真实差异
3. **估计效应量**：基于历史数据预估最小可检测提升幅度（如 CTR 提升 2%）
4. **使用公式计算**：n ≈ (Z_α/2 + Z_β)² × p×(1-p) / Δ²，其中 p 为基线转化率
5. **在线验证**：运行期间持续监控，达到样本量后停止并做假设检验
