"""Advertising Capability/Skill lifecycle services.
...
class AdCapabilityLifecycleMixin:
    ...
    def _load_skill_plugin(skill_dir: Any, api_client=None) -> Optional[Skill]:
        ...
        verified, reason = AdCapabilityLifecycleMixin._verify_skill_plugin(
    ...
    def _discover_capability(platform: str, api_client: Any = None) -> Any:
        ...
        """
        return ProviderBindings.discover_capability(platform, api_client)
