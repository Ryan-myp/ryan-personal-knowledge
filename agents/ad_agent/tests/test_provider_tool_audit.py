from agents.ad_agent.scripts.audit_provider_tools import (
    _covered_tool_names,
...
def test_tool_source_audit_can_detect_registered_tools_missing_from_coverage():
    coverage = {
...
def test_tool_source_audit_discovers_all_installed_channels_without_issues():
...
def test_tool_source_audit_reports_scoped_official_inventory_separately_from_tools():
    report = audit_provider_tools()
...
def test_tool_source_audit_keeps_client_method_tool_surface_chain_complete():
    report = audit_provider_tools()
