...
class PersistenceBackend(KnowledgeStorePort, Protocol):
    ...
    # MCP declarations and discovered Tool schemas are tenant-scoped data.
    # The backend never persists the referenced secret itself.
    ...
    def update_mcp_server(
        self, server_id: str, tenant_id: str, data: dict[str, Any],
    ) -> Optional[dict]: ...
    def upsert_mcp_tool(self, data: dict[str, Any]) -> dict: ...
    def list_mcp_tools(
        self, server_id: str, tenant_id: Optional[str] = None,
    ) -> list[dict]: ...
    def get_mcp_tool(self, tool_id: str, tenant_id: str) -> Optional[dict]: ...
    def update_mcp_tool(
        self, tool_id: str, tenant_id: str, data: dict[str, Any],
    ) -> Optional[dict]: ...
