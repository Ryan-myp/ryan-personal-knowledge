...
API_SURFACE = [
    ...
    {"resource": "campaign_bundle", "action": "create_all_in_one_spark", "method": "create_all_in_one_spark_ad", "status": "implemented", "provider_operation": "business/spark_ad/create", "notes": "Current v1.3 one-step surface for Reach, Video Views and Community Interaction; Traffic is routed through Upgraded Smart+; live writes remain explicitly disabled until paused-state verification."},
    {"resource": "smart_plus_campaign", "action": "create", "method": "create_smart_plus_campaign", "status": "implemented", "provider_operation": "smart_plus/campaign/create", "notes": "Upgraded Smart+ campaign endpoint; dry-run only until test-account paused-state verification."},
    {"resource": "smart_plus_ad_group", "action": "create", "method": "create_smart_plus_adgroup", "status": "implemented", "provider_operation": "smart_plus/adgroup/create", "notes": "Upgraded Smart+ ad group endpoint; dry-run only."},
    {"resource": "smart_plus_ad", "action": "create", "method": "create_smart_plus_ad", "status": "implemented", "provider_operation": "smart_plus/ad/create", "notes": "Upgraded Smart+ ad endpoint; dry-run only."},
