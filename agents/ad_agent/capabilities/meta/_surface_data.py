...
OFFICIAL_INVENTORY = [
    ...
    {"resource": "lookalike_audience", "action": "create", "status": "implemented", "surface_method": "create_audience", "provider_operation": "AdAccount/{account_id}/customaudiences (subtype=LOOKALIKE, lookalike_spec)"},
    {"resource": "lookalike_audience", "action": "get", "status": "implemented", "surface_method": "get_audience", "provider_operation": "CustomAudience/{audience_id} (lookalike_spec)"},
    {"resource": "lookalike_audience", "action": "update", "status": "implemented", "surface_method": "update_audience", "provider_operation": "CustomAudience/{audience_id}"},
    {"resource": "lookalike_audience", "action": "delete", "status": "implemented", "surface_method": "delete_audience", "provider_operation": "CustomAudience/{audience_id}"},
    {"resource": "image_asset", "action": "list", "status": "implemented", "surface_method": "list_image_assets", "provider_operation": "AdAccount/{account_id}/adimages"},
...
API_SURFACE = [
    ...
    {"resource": "image_asset", "action": "list", "method": "list_image_assets", "status": "implemented"},
    {"resource": "image_asset", "action": "upload", "method": "upload_image_asset", "status": "implemented"},
    {"resource": "video_asset", "action": "list", "method": "list_video_assets", "status": "implemented"},
    {"resource": "video_asset", "action": "upload", "method": "upload_video_asset", "status": "implemented"},
    ...
    {"resource": "lookalike_audience", "action": "create", "method": "create_audience", "status": "implemented"},
    {"resource": "lookalike_audience", "action": "get", "method": "get_audience", "status": "implemented"},
    {"resource": "lookalike_audience", "action": "update", "method": "update_audience", "status": "implemented"},
    {"resource": "lookalike_audience", "action": "delete", "method": "delete_audience", "status": "implemented"},
