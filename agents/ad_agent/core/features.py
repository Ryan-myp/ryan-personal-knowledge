...
class RuntimeExecutionServices(Protocol):
    """External-system- and business-neutral execution port.
    ...
    def simulate_write(self, tool: Any, value: dict[str, Any], namespace: str) -> Any: ...
    ...
    def persist_tool_result(
        self, session: Any, turn_id: str, tool: Any, namespace: str,
