"""
tools/providers/meta/provider.py - Meta Tool Source 定义
"""
...
class MetaToolSource(BaseProviderToolSource):
    platform_name = "meta"
    ...
    def _extended_provider_tools(self, client):
        ...
        test_conversion_schema = {
            **conversion_schema,
            ...
            "requires": [
                *conversion_schema["requires"], "test_event_code"
            ],
            "properties": {
        ...
        tools = [
            ...
            method_tool(
                ...
                requires=meta_targeting_search_schema()["requires"],
            ...
            method_tool(
                ...
                requires=["audience_id", "upload_schema", "upload_data"],
            ...
            method_tool(
                ...
                requires=["image_url"], action="upload", resource_type="image_asset",
            ...
            method_tool(
                ...
                requires=["file_url"], action="upload", resource_type="video_asset",
            ...
            method_tool(
                ...
                requires=conversion_schema["requires"], action="send",
            ...
            method_tool(
                ...
                requires=test_conversion_schema["requires"],
            ...
            method_tool(
                ...
                requires=custom_conversion_schema["requires"],
            ...
            method_tool(
                ...
                requires=["custom_conversion_id", "updates"], action="update",
                resource_type="custom_conversion", resource_id_field="custom_conversion_id",
            ...
            method_tool(
                ...
                requires=["custom_conversion_id"], action="delete",
                resource_type="custom_conversion", resource_id_field="custom_conversion_id",
            ...
            method_tool(
                ...
                requires=["page_id", "form_id", "lead_id"],
            ...
            method_tool(
                ...
                requires=lead_form_schema["requires"],
            ...
            method_tool(
                ...
                requires=["business_id", "name", "vertical"],
            ...
            method_tool(
                ...
                requires=meta_lead_ad_schema()["requires"],
            ...
            method_tool(
                ...
                requires=meta_catalog_ad_schema()["requires"],
                action="create", resource_type="ad", parent_resource_type="ad_set",
                resource_id_field="ad_id", parent_resource_id_field="adset_id",
            ...
            method_tool(
                ...
                requires=meta_messaging_ad_schema()["requires"],
        ...
        tools.append(method_tool(
            ...
            requires=engagement_schema["requires"],
        ...
        tools.extend([
            ...
            method_tool(
                ...
                requires=lookalike_schema["requires"],
        ...
        for method_name, resource_type, resource_id, intent in (
            ...
            tools.append(method_tool(
                ...
                requires=["account_id", resource_id],
    ...
    def register_tools(self) -> list[tuple[ToolDefinition, ToolHandler]]:
        ...
        tools.append((ToolDefinition(
            ...
            action="boost", resource_type="post", intent_types=["boost_post"],
            risk_level=RiskLevel.MEDIUM,
            effect_class=ToolEffect.WRITE,
            replay_policy=ReplayPolicy.UNSAFE,
        ...
        tools.append((ToolDefinition(
            ...
            action="create", resource_type="creative", intent_types=["create_creative"],
            risk_level=RiskLevel.MEDIUM,
            effect_class=ToolEffect.WRITE,
            replay_policy=ReplayPolicy.UNSAFE,
        ...
        for resource_type, resource_id, tool_suffix in [
            ...
            tools.append((ToolDefinition(
                ...
                parent_resource_type={"ad_set": "campaign", "ad": "ad_set"}.get(resource_type),
                intent_types={
                    "campaign": [
