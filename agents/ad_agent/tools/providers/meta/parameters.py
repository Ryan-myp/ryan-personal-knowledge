"""Meta Marketing API creation contracts owned by the Meta Tool Source."""
...
def meta_lead_form_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["name", "questions", "privacy_policy"],
        "properties": {
...
def meta_campaign_schema() -> dict[str, Any]:
    return {
        ...
        "requires": ["objective", "special_ad_categories"],
        "requires_any_of": [["daily_budget", "lifetime_budget", "budget"]],
        "properties": {
            "account_id": _field("string", "Meta ad account ID"),
...
def meta_adset_schema() -> dict[str, Any]:
    return {
        ...
        "requires": ["optimization_goal", "billing_event", "targeting"],
...
def meta_catalog_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["page_id", "product_set_id", "link"],
        "properties": {
            "adset_id": _field("string", "Parent Meta Ad Set ID"),
            "name": _field("string", "Ad name", maxLength=400),
            "page_id": _field(
...
def meta_messaging_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["page_id", "messaging_app", "call_to_action_type"],
        "properties": {
            "adset_id": _field("string", "Parent Meta Ad Set ID"),
            "name": _field("string", "Ad name", maxLength=400),
            "page_id": _field(
...
def meta_engagement_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["page_id", "engagement_type"],
        "properties": {
            "adset_id": _field("string", "Parent Meta Ad Set ID"),
            "name": _field("string", "Ad name", maxLength=400),
            "page_id": _field(
            ...
            "post_id": _field(
                ...
                manual_entry={
                    "title": "帖子 ID",
                    "instructions": "请提供该 Facebook Page 上已有帖子的 ID；当前 Tool Source 没有通用 Page 帖子列表接口。",
