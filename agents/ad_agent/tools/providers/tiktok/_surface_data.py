...
OFFICIAL_INVENTORY = [
    ...
    {"resource": "targeting_reference", "action": "read", "status": "implemented", "surface_method": "list_regions", "provider_operation": "tool/region|search/region|tool/carrier|tool/os_version|tool/device_model"},
...
API_SURFACE = [
    ...
    {"resource": "browser", "action": "list", "status": "not_applicable", "gap": "TikTok Ads v1.3 has no verified browser directory endpoint; browser identifiers remain manual input"},
    {"resource": "carrier", "action": "list", "method": "list_carriers", "status": "implemented"},
    {"resource": "device", "action": "list", "status": "not_applicable", "gap": "TikTok Ads v1.3 exposes device models rather than a general device directory"},
    {"resource": "operating_system", "action": "list", "method": "list_os_versions", "status": "implemented"},
    ...
    {"resource": "conversion", "action": "list", "status": "not_applicable", "gap": "No verified generic TikTok Ads v1.3 conversion-event directory endpoint; conversion values are entered from Ads Manager or Events Manager"},
    {"resource": "conversion", "action": "get", "status": "not_applicable", "gap": "No verified generic TikTok Ads v1.3 conversion-event detail endpoint"},
    ...
    {"resource": "brand_safety", "action": "list", "status": "not_applicable", "gap": "No verified generic brand-safety category directory endpoint"},
    {"resource": "brand_safety_partner", "action": "get", "method": "get_brand_safety_partner_status", "status": "implemented"},
