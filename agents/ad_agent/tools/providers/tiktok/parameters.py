...
# different request shape and the Tool Source must not accidentally send these
...
def tiktok_campaign_schema() -> dict[str, Any]:
    return {
        ...
        "requires": ["objective_type", "budget_mode", "campaign_type"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
            "name": _field(
                "string", "Campaign name; max 60 characters",
                input_aliases=["名称", "广告系列名称", "campaign name"],
            ),
            "objective_type": _field(
                ...
                option_aliases={
                    ...
                    "PRODUCT_SALES": ["product sales", "product ad", "销售", "销售广告", "商品销售", "商品广告"],
            ...
            "campaign_type": _field(
                ...
                option_aliases={
                    "REGULAR_CAMPAIGN": ["regular campaign", "standard campaign", "常规广告系列", "常规广告", "普通广告系列"],
...
def tiktok_audience_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["name", "calculate_type", "file_paths"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
...
def tiktok_audience_file_upload_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["file_path", "calculate_type"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
            "file_path": _field(
...
def tiktok_image_upload_schema() -> dict[str, Any]:
    ...
    return {
        "required": ["account_id"],
        "requires": [],
        "requires_exactly_one_of": [["file_path", "image_url", "file_id"]],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
...
def tiktok_video_upload_schema() -> dict[str, Any]:
    ...
    return {
        "required": ["account_id"],
        "requires": [],
        "requires_exactly_one_of": [["file_path", "video_url", "video_id", "file_id"]],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
...
def tiktok_pixel_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "properties": {
            ...
            # TikTok v1.3 rejects pixel/list page sizes above 20.
            "limit": _field("integer", "Maximum number of Pixels", minimum=1, maximum=20),
...
def tiktok_creative_portfolio_get_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["creative_portfolio_id"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
...
def tiktok_identity_create_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["account_id", "display_name", "image_uri"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
...
def tiktok_identity_video_info_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["account_id", "identity_type", "identity_id", "item_id"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
    ...
    return {
        ...
        "properties": {
            ...
            "age_groups": _field(
                ...
                option_aliases={
                    "AGE_18_24": ["18-24", "18 到 24", "18至24", "18 到 35", "18至35"],
                    "AGE_25_34": ["25-34", "25 到 34", "25至34", "18 到 35", "18至35"],
                    "AGE_35_44": ["35-44", "35 到 44", "35至44", "18 到 35", "18至35"],
                },
...
def tiktok_targeting_update_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["campaign_id", "adgroup_id", "updates"],
        "properties": {
            "account_id": _field("string", "TikTok advertiser ID"),
            "campaign_id": _field("string", "Parent campaign ID"),
...
def tiktok_ad_schema() -> dict[str, Any]:
    return {
        ...
        "requires": ["campaign_id", "identity_id"],
        "requires_any_of": [["media", "creatives"]],
        "properties": {
...
def tiktok_creative_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["campaign_id", "adgroup_id", "identity_id"],
        "requires_any_of": list(base.get("requires_any_of", [])),
...
def _tiktok_format_ad_schema(
    ...
    return {
        ...
        "requires_any_of": [[*asset_properties.keys()]],
        "properties": properties,
        ...
        "properties": {
            ...
            "page_id": _field(
                ...
                manual_entry={
                    ...
                    "instructions": "请从 TikTok Ads Manager 或 Instant Page Editor 复制已发布的页面/表单 ID；当前 Tool Source 没有稳定的页面列表接口。",
...
def tiktok_app_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["campaign_id", "app_id", "promotion_type"],
        "requires_any_of": [["media", "creatives"]],
        "properties": {
            "campaign_id": _field("string", "Parent campaign ID"),
            "adgroup_id": _field("string", "Parent ad group ID"),
...
def tiktok_all_in_one_spark_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires_any_of": [["location_ids", "saved_audience_id"]],
        "conditional_rules": [
            {
...
def tiktok_smart_plus_campaign_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["campaign_name", "objective_type"],
        "conditional_rules": [
        ...
        "properties": {
            ...
            "objective_type": _field(
                ...
                option_aliases={
                    "APP_PROMOTION": ["app", "app promotion", "app conversion", "应用推广", "应用转化"],
                    "TRAFFIC": ["traffic", "website traffic", "流量", "网站流量"],
                    "SALES": ["sales", "销售"],
                    "PRODUCT_SALES": ["product sales", "商品销售"],
                    "WEB_CONVERSIONS": ["web conversions", "web conversion", "网站转化"],
                    "LEAD_GENERATION": ["leads", "lead generation", "线索获客"],
                },
                intent_field="objective",
                intent_map={
                    "app": "APP_PROMOTION",
                    "sales": "PRODUCT_SALES",
                    "traffic": "TRAFFIC",
            ...
            "budget_mode": _field("string", "Campaign budget mode", enum=["BUDGET_MODE_DYNAMIC_DAILY_BUDGET", "BUDGET_MODE_TOTAL"]),
            "budget": _field("number", "Campaign budget; TikTok Smart+ requires at least 20", minimum=20),
...
def tiktok_smart_plus_adgroup_schema() -> dict[str, Any]:
    ...
    return {
        ...
        # Runtime can pass it through without asking the operator to enter it
        # twice or teaching Runtime about TikTok objectives.
        "conditional_rules": [
            {
                "if": {"objective_type": "APP_PROMOTION"},
                "required": ["app_id", "operating_systems"],
                "allowed": {
                    "promotion_type": ["APP_ANDROID", "APP_IOS"],
                    "optimization_goal": ["INSTALL", "IN_APP_EVENT", "VALUE"],
                },
                "message": "APP_PROMOTION requires an app, matching operating system and Smart+ app goal",
            },
            {
                "if": {"objective_type": "LEAD_GENERATION"},
                "required": ["promotion_target_type"],
                "allowed": {
                    "promotion_type": [
                        "LEAD_GENERATION",
                    ...
                    "optimization_goal": ["LEAD_GENERATION", "CLICK", "CONVERSATION"],
                },
                "message": "LEAD_GENERATION requires a supported lead promotion type, target and goal",
            },
            {
                "if": {"objective_type": "TRAFFIC"},
                "allowed": {
                    "promotion_type": ["WEBSITE"],
                    "optimization_goal": ["CLICK", "TRAFFIC_LANDING_PAGE_VIEW"],
                },
        ...
        "properties": {
            ...
            "objective_type": _field(
                "string", "Parent campaign objective used for Smart+ cascade validation",
                enum=TIKTOK_SMART_PLUS_OBJECTIVES,
                intent_field="objective",
                intent_map={
                    "app": "APP_PROMOTION",
            ...
            "targeting_spec": _field(
                "object", "Advanced targeting payload; the Provider builds this from the targeting fields above",
                properties={
                    "location_ids": _field("array", "Target locations", items={"type": "string"}),
                    "saved_audience_id": _field(
                        "string", "Saved audience ID returned by tiktok_list_audiences",
                        minLength=1, lookup_tool="tiktok_list_audiences",
                        lookup_result_key="audiences",
                        selection_value_fields=["audience_id", "id"],
                        selection_label_fields=["audience_name", "name", "display_name", "id"],
                    ),
            ...
            "budget_mode": _field("string", "Ad group budget mode", enum=["BUDGET_MODE_DYNAMIC_DAILY_BUDGET", "BUDGET_MODE_TOTAL", "BUDGET_MODE_INFINITE"]),
            "budget": _field("number", "Ad group budget; TikTok Smart+ requires at least 20 when supplied", minimum=20),
...
def tiktok_smart_plus_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["campaign_id", "adgroup_id", "ad_name"],
        "requires_any_of": [["tiktok_item_id", "video_id", "image_ids"]],
        "conditional_rules": [
            {
                "if": {"objective_type": "LEAD_GENERATION"},
                "required": ["page_list"],
                "message": "LEAD_GENERATION Smart+ ads require a selected Instant Page",
            },
        ],
        "properties": {
            "request_id": _field("string", "System-generated idempotency key", minLength=1, ui_hidden=True),
            ...
            "objective_type": _field(
                "string", "Parent campaign objective used for Smart+ ad validation",
                enum=TIKTOK_SMART_PLUS_OBJECTIVES,
                intent_field="objective",
                intent_map={
                    "app": "APP_PROMOTION",
            ...
            "video_file_name": _field("string", "Optional uploaded video file name"),
            ...
            "image_web_uris": _field("array", "Image web URIs returned by the TikTok image library", minItems=1, items={"type": "string", "minLength": 1}, lookup_tool="tiktok_list_images", lookup_result_key="images", selection_value_fields=["web_uri", "image_url", "image_id"], selection_label_fields=["file_name", "image_name", "web_uri", "image_id"]),
            "ad_text": _field("string", "Primary ad text", minLength=1, maxLength=100),
            ...
            "tracking_app_id": _field(
                "string", "Tracking app ID returned by TikTok", minLength=1,
                lookup_tool="tiktok_list_apps", lookup_result_key="apps",
                selection_value_fields=["app_id", "id"],
                selection_label_fields=["app_name", "name", "display_name", "id"],
            ),
            "click_tracking_url": _field(
                "string", "Click tracking URL", minLength=1,
                manual_entry={
                    "title": "点击追踪链接",
                    "instructions": "请输入已备案且可访问的点击追踪 URL；TikTok 不提供可替代用户填写的通用目录接口。",
                    "source": "provider_tracking_url",
                },
            ),
            "impression_tracking_url": _field(
                "string", "Impression tracking URL", minLength=1,
                manual_entry={
                    "title": "展示追踪链接",
                    "instructions": "请输入已备案且可访问的展示追踪 URL；TikTok 不提供可替代用户填写的通用目录接口。",
                    "source": "provider_tracking_url",
                },
            ),
            "product_info": _field("object", "Optional product information", additionalProperties=False),
            "catalog_creative_info": _field("object", "Optional catalog creative configuration", additionalProperties=False),
            "deeplink_type": _field("string", "Deeplink type", enum=["NORMAL", "DEFERRED"]),
            "creative_list": _field(
                "array", "TikTok Smart+ creative list; each item contains creative_info",
                minItems=1,
                items={
                    "type": "object",
                    "required": ["creative_info"],
                    "properties": {
                        "creative_info": {
                            "type": "object",
                            "additionalProperties": False,
                            "properties": {
                                "ad_format": _field("string", "Creative format"),
                                "tiktok_item_id": _field("string", "Authorized TikTok post ID"),
                                "video_id": _field("string", "Uploaded video ID"),
                                "video_info": _field("object", "Provider video_info", properties={"video_id": _field("string", "Uploaded video ID", minLength=1), "file_name": _field("string", "Video file name")}, additionalProperties=False),
                                "image_ids": _field("array", "Uploaded image IDs", items={"type": "string"}),
                                "image_info": _field("array", "Provider image_info", minItems=1, items={"type": "object", "required": ["web_uri"], "properties": {"web_uri": _field("string", "Image web URI", minLength=1)}, "additionalProperties": False}),
                                "image_web_uris": _field("array", "Image web URIs", items={"type": "string", "minLength": 1}),
            ...
            "ad_configuration": _field(
                "object", "TikTok Smart+ CTA and tracking configuration",
                properties={
                    "call_to_action_id": _field("string", "TikTok CTA ID", minLength=1),
                    "tracking_info": _field(
                        "object", "Tracking configuration",
                        properties={
                            "tracking_app_id": _field(
                                "string", "Tracking app ID", minLength=1,
                                lookup_tool="tiktok_list_apps", lookup_result_key="apps",
                                selection_value_fields=["app_id", "id"],
                                selection_label_fields=["app_name", "name", "display_name", "id"],
                            ),
                            "click_tracking_url": _field(
                                ...
                                manual_entry={
                                    "title": "点击追踪链接",
                                    "instructions": "请输入已备案且可访问的点击追踪 URL。",
                                    "source": "provider_tracking_url",
                                },
                            ),
                            "impression_tracking_url": _field(
                                ...
                                manual_entry={
                                    "title": "展示追踪链接",
                                    "instructions": "请输入已备案且可访问的展示追踪 URL。",
                                    "source": "provider_tracking_url",
                                },
                            ),
                        },
            ...
            "deeplink_list": _field(
                "array", "Optional Smart+ deeplinks", minItems=1,
                items={
                    "type": "object",
                    "required": ["deeplink"],
                    "properties": {
                        "deeplink": _field("string", "Deeplink", minLength=1),
                        "deeplink_type": _field("string", "Deeplink type", enum=["NORMAL", "DEFERRED"]),
                    },
                    "additionalProperties": False,
                },
