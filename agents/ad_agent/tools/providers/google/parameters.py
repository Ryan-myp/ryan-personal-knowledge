"""Google Ads creation contracts owned by the Google Tool Source."""
    ...
    return _object({
        "merchant_id": _field(
            ...
            manual_entry={
                ...
                "instructions": "请输入已关联到 Google Ads 账号的 Merchant Center ID；当前 Tool Source 没有 Merchant Center 列表接口。",
            },
        ),
    ...
    return _object({
        "hotel_center_id": _field(
            ...
            manual_entry={
                ...
                "instructions": "请输入已关联到 Google Ads 的 Hotel Center 账号 ID；当前 Tool Source 没有 Hotel Center 列表接口。",
            },
        ),
...
def google_travel_campaign_setting_schema() -> dict[str, Any]:
    ...
    return _object({
        "travel_account_id": _field(
            ...
            manual_entry={
                "title": "Travel 账号 ID",
                "instructions": "请输入已关联到 Google Ads 的 Travel 账号 ID；当前 Tool Source 没有 Travel 账号列表接口。",
            },
        ),
...
def google_campaign_schema() -> dict[str, Any]:
    return {
        ...
        "requires_any_of": [["daily_budget", "budget"]],
        "properties": {
...
def google_app_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["headlines", "descriptions"],
        "properties": {
...
def google_campaign_criterion_item_schema() -> dict[str, Any]:
    ...
    return _object({
        ...
        "location_id": _field(
            ...
            manual_entry={
                "title": "地理位置常量 ID",
                "instructions": "请从 Google Ads 地理位置目标列表或 Google Ads UI 复制常量 ID/资源名；当前没有本 Tool Source 的地理位置目录 Tool。",
        ...
        "language_id": _field(
            ...
            manual_entry={
                "title": "语言常量 ID",
                "instructions": "请从 Google Ads 语言目标列表或 UI 复制常量 ID/资源名；当前没有本 Tool Source 的语言目录 Tool。",
        ...
        "user_interest_id": _field(
            ...
            manual_entry={
                "title": "用户兴趣 ID",
                "instructions": "请从 Google Ads 用户兴趣目标列表或 UI 复制 ID/资源名；当前没有本 Tool Source 的用户兴趣目录 Tool。",
        ...
        "topic_id": _field(
            ...
            manual_entry={
                "title": "主题目标 ID",
                "instructions": "请从 Google Ads 主题目标列表或 UI 复制主题常量 ID/资源名；当前没有本 Tool Source 的主题目录 Tool。",
...
def google_ad_schema() -> dict[str, Any]:
    return {
        ...
        "requires": ["final_url"],
        "requires_any_of": [["headlines", "responsive_search_ad"]],
        "properties": {
...
def google_responsive_display_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["headlines", "long_headline", "descriptions", "business_name"],
        "properties": {
...
def google_video_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["video_ad_format", "video_id", "final_url"],
        "properties": {
...
def google_demand_gen_multi_asset_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["headlines", "descriptions", "business_name"],
        "properties": {
...
def google_demand_gen_carousel_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["headline", "description", "carousel_cards"],
        "properties": {
            "ad_group_id": _field("string", "Parent Demand Gen ad group ID", minLength=1),
            "name": _field("string", "Ad name", minLength=1, maxLength=255),
            "final_url": _field("string", "Final URL", minLength=1),
...
def google_demand_gen_video_responsive_ad_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "requires": ["business_name", "videos", "headlines", "descriptions"],
        "properties": {
            "ad_group_id": _field("string", "Parent Demand Gen ad group ID", minLength=1),
            "name": _field("string", "Ad name", minLength=1, maxLength=255),
            "final_url": _field("string", "Final URL", minLength=1),
...
def google_demand_gen_product_ad_schema() -> dict[str, Any]:
    ...
    return {
        "required": ["ad_group_id", "name"],
        "requires": ["headline", "description", "business_name", "logo_image", "call_to_action"],
        "properties": {
            "ad_group_id": _field("string", "Parent Demand Gen ad group ID", minLength=1),
            "name": _field("string", "Ad name", minLength=1, maxLength=255),
