"""
tools/providers/google/provider.py - Google Tool Source 定义
"""
...
def _build_specialized_ad_args(
    ...
    execution.  This second guard protects direct Tool Source handler calls and
...
# every reusable Google resource ID exposed by the Tool Source, including
...
class GoogleToolSource(BaseProviderToolSource):
    ...
    # in the current Tool Source. This is deliberately an explicit exclusion,
    # so the tool_source audit cannot mistake compatibility code for coverage.
    ...
    def _extended_provider_tools(self, client):
        ...
        tools = [
            ...
            method_tool(
                ...
                properties=experiment_schema["properties"],
                required=["name", "type"], requires=["name", "type"],
            ...
            method_tool(
                ...
                required=["experiment_id", "updates"], requires=["updates"],
            ...
            method_tool(
                ...
                required=["campaign_id"], requires=["campaign_id"],
            ...
            method_tool(
                ...
                requires=app_ad_group_schema["requires"],
            ...
            method_tool(
                ...
                requires=app_ad_schema["requires"],
            ...
            method_tool(
                ...
                required=["ad_group_id"], requires=["ad_group_id"],
            ...
            method_tool(
                ...
                requires=asset_create_schema["requires"],
            ...
            method_tool(
                ...
                requires=["campaign_id", "asset_id", "field_type"],
            ...
            method_tool(
                ...
                requires=["asset_group_id", "asset_id", "field_type"],
            ...
            method_tool(
                ...
                requires=conversion_action_schema["requires"],
            ...
            method_tool(
                ...
                requires=["criteria"], action="create", resource_type="campaign_criterion",
            ...
            method_tool(
                ...
                requires=bidding_strategy_schema["requires"],
            ...
            method_tool(
                ...
                requires=user_list_schema["requires"],
            ...
            method_tool(
                ...
                requires=["headlines", "descriptions", "final_url"],
            ...
            method_tool(
                ...
                requires=google_keyword_schema()["requires"],
            ...
            method_tool(
                ...
                requires=["updates"], action="update", resource_type="keyword",
            ...
            method_tool(
                ...
                requires=asset_group_schema["requires"], action="create",
            ...
            method_tool(
                ...
                requires=google_product_group_schema()["requires"],
            ...
            method_tool(
                ...
                requires=["updates"], action="update", resource_type="product_group",
            ...
            method_tool(
                ...
                requires=listing_filter_schema["requires"],
            ...
            method_tool(
                ...
                requires=["updates"], action="update",
                resource_type="listing_group_filter",
                parent_resource_type="asset_group",
                resource_id_field="listing_group_filter_id",
                parent_resource_id_field="asset_group_id",
            ...
            method_tool(
                ...
                requires=google_responsive_display_ad_schema()["requires"],
                action="create", resource_type="ad", parent_resource_type="ad_group",
                resource_id_field="ad_id", parent_resource_id_field="ad_group_id",
            ...
            method_tool(
                ...
                requires=google_video_ad_schema()["requires"],
                action="create", resource_type="ad", parent_resource_type="ad_group",
                resource_id_field="ad_id", parent_resource_id_field="ad_group_id",
        ...
        tools.append(method_tool(
            ...
            requires=google_ad_group_schema()["requires"],
            action="create", resource_type="ad_group", parent_resource_type="campaign",
        ...
        def _ad_tool(
            *, name: str, description: str, method_name: str, schema: dict[str, Any],
            ...
            return method_tool(
                ...
                requires_any_of=schema.get("requires_any_of", []),
        ...
        tools.extend([
            ...
            method_tool(
                ...
                requires=["feed_id", "attribute_values"],
            ...
            method_tool(
                ...
                requires=["feed_item_resource_name", "updates"],
            ...
            method_tool(
                ...
                requires=["category", "origin", "updates"],
            ...
            method_tool(
                ...
                requires=["campaign_id", "category", "origin", "updates"],
...
def create_google_tool_source(api_client: Optional[GoogleAdsAPIClient] = None) -> GoogleToolSource:
    cap = GoogleToolSource()
