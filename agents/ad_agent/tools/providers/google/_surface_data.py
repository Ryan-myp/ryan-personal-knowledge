...
OFFICIAL_INVENTORY = [
    ...
    {"resource": "feed", "action": "crud", "status": "planned", "gap": "Google Ads v24 no longer accepts the legacy Feed resource GAQL/mutation surface; requires a versioned replacement or Merchant Center integration", "provider_operation": "Legacy FeedService / FeedItemService (unavailable in v24)"},
...
API_SURFACE = [
    ...
    {"resource": "feed", "action": "list", "method": "list_feeds", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy Feed GAQL resource"},
    {"resource": "feed", "action": "get", "method": "get_feed", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy Feed GAQL resource"},
    {"resource": "feed", "action": "create", "method": "create_feed", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed", "action": "update", "method": "update_feed", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed", "action": "delete", "method": "delete_feed", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed_item", "action": "list", "method": "list_feed_items", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy FeedItem GAQL resource"},
    {"resource": "feed_item", "action": "get", "method": "get_feed_item", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy FeedItem GAQL resource"},
    {"resource": "feed_item", "action": "create", "method": "create_feed_item", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
    {"resource": "feed_item", "action": "update", "method": "update_feed_item", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
    {"resource": "feed_item", "action": "delete", "method": "delete_feed_item", "status": "planned", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
