...
PROVIDER_METADATA = {
    ...
    "managed_write_resources": ["campaign", "ad_group", "ad", "asset_group"],
}
...
OFFICIAL_INVENTORY = [
    ...
    {"resource": "feed", "action": "crud", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed GAQL/mutation surface", "provider_operation": "Legacy FeedService (unavailable in v24)"},
    {"resource": "feed_item", "action": "crud", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem GAQL/mutation surface", "provider_operation": "Legacy FeedItemService (unavailable in v24)"},
...
API_SURFACE = [
    ...
    {"resource": "experiment", "action": "list", "method": "list_experiments", "status": "implemented", "notes": "GAQL read surface"},
    {"resource": "experiment", "action": "get", "method": "get_experiment", "status": "implemented"},
    {"resource": "experiment", "action": "create", "method": "create_experiment", "status": "implemented", "notes": "Provider payload adapter; execution remains dry-run-only until test-account verification"},
    {"resource": "experiment", "action": "update", "method": "update_experiment", "status": "implemented", "notes": "Mutable fields only; execution remains dry-run-only"},
    {"resource": "experiment", "action": "delete", "method": "delete_experiment", "status": "implemented", "notes": "Execution remains dry-run-only"},
    {"resource": "experiment", "action": "schedule", "method": "schedule_experiment", "status": "implemented", "notes": "Dedicated ExperimentService lifecycle RPC; execution remains dry-run-only"},
    {"resource": "experiment", "action": "end", "method": "end_experiment", "status": "implemented", "notes": "Dedicated ExperimentService lifecycle RPC; execution remains dry-run-only"},
    ...
    {"resource": "feed", "action": "list", "method": "list_feeds", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed GAQL resource"},
    {"resource": "feed", "action": "get", "method": "get_feed", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed GAQL resource"},
    {"resource": "feed", "action": "create", "method": "create_feed", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed", "action": "update", "method": "update_feed", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed", "action": "delete", "method": "delete_feed", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy Feed mutation surface"},
    {"resource": "feed_item", "action": "list", "method": "list_feed_items", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem GAQL resource"},
    {"resource": "feed_item", "action": "get", "method": "get_feed_item", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem GAQL resource"},
    {"resource": "feed_item", "action": "create", "method": "create_feed_item", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
    {"resource": "feed_item", "action": "update", "method": "update_feed_item", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
    {"resource": "feed_item", "action": "delete", "method": "delete_feed_item", "status": "not_applicable", "gap": "Google Ads v24 no longer exposes the legacy FeedItem mutation surface"},
